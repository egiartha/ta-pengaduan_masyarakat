                                    ...
                                    <div class="container-fluid mt-4">
                                        <div class="row">
                                            <p>
                                                ...
                                                <a href="/profil_foto_hapus/{{Auth::user()->id}}" class="btn btn-danger btn-sm ml-5 delete-confirm ">Hapus</a>​
                                            </p>
                                        </div>
                                        <br>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="number" name="nik" value="{{Auth::user()->nik}}" onKeyPress="if(this.value.length == 16) return false;" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
