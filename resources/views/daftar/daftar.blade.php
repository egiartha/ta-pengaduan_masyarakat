        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4 bg-light shadow-2 rounded">
                <div class="card-body ">
                    ...
                    @endif
                    <form method="POST" enctype="multipart/form-data" action="/daftar_post">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="alamat">Foto/Scan KTP : @error('foto_ktp') <span class="text-danger">{{$message}} </span> @enderror </label>
